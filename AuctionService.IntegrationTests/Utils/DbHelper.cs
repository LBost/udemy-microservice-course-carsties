...
namespace AuctionService.IntegrationTests.Utils
{
    public static class DbHelper
    {
        ...
        {
            db.Auctions.AddRange(GetAuctions());
            db.SaveChanges();
        }
        ...
        public static Guid GetAuctionId => GetAuctions().FirstOrDefault().Id;
        public static string GetAuctionSeller => GetAuctions().FirstOrDefault().Seller;

        public static CreateAuctionDto GetAuctionDtoForCreate()
        {
